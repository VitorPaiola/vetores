...
public class ExibirOrdemInversaV2 {
    public static void main(String[] args) {
        ...
        List<Integer> ordemInversa = ordemInversa(numeros);
    ...
    public static List<Integer> ordemInversa(List<Integer> numeros) {
    ...
    public static void imprimirResultados(List<Integer> ordemInversa) {
        System.out.println("Numeros na ordem inversa: " + ordemInversa);
    }
}
